...
export default {
  ...
  methods: {
    toggleHeader() {
      if (this.bIsTheader) {
        const el = this.$refs.headerTextarea
        if (el) {
          try {
      ...
      this.bIsTheader = !this.bIsTheader
    },
    holdDone(){
